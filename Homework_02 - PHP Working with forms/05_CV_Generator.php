...
<div id="container">
    <form action="CVGenerator.php" method="post" id="CV-form" name="mainForm">
        ...
        <div class="forms">
            ...
            <input type="text" name="date" id="date" placeholder="dd/mm/yyyy" required="true"/><br/>
        ...
        <div class="forms">
            ...
            <input type="text" id="from" name="from" placeholder="dd/mm/yyyy" required="true"/><br/>
            <label for="from">To</label>
            <input type="text" id="to" name="to" placeholder="dd/mm/yyyy" required="true"/><br/>
        </div>
